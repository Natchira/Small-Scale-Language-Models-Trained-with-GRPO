...
model_configs = [
    {
        ...
        "fine_tuned_model_path": "Ppear/Qwen2.5-3B-GRPO-Physics_expo"
    }
]
...
for config in model_configs:
    fine_tuned_model = os.path.basename(config["fine_tuned_model_path"])
    print(f"Evaluating {fine_tuned_model} ...")

    cmd = [
        "python", "evaluate_model_pair_args.py",
        "--n", str(config["n"]),
